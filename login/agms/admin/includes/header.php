...
?>
      <!--logo start-->
      <a href="dashboard.php" class="logo"><span class="lite"><strong> <img src="images/mclogow-half.png" style="height: 35px;" alt=""/>&nbsp; MALCOLM LISMORE GALLERY | Admin </strong></span></a>
      <!--logo end-->
...
<?php } ?>
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
			  ...
			  <li>
                <a href="add-admin-profile.php"><i class="icon_profile"></i> Add Admin Profile</a>
              </li>

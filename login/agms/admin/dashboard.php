...
<head>
  ...
  <title>Malcolm Lismore Photography - Admin Dashboard</title>
...
?>
             <i class="fa fa-user"></i>
              ...
              <div class="title"> <a class="dropdown-item" href="manage-artist.php">Total Photographers</a></div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
...
?>
              <i class="fa fa-file"></i>
              <div class="count"><?php echo $artcount;?></div>
             <div class="title"> <a class="dropdown-item" href="manage-art-type.php">Total Service Types</a></div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
...
?>
              ...
              <div class="title"> <a class="dropdown-item" href="manage-art-medium.php">Total Product Type</a></div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
...
?>
             ...
             <div class="title"> <a class="dropdown-item" href="manage-art-product.php">Total Stocks</a></div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
